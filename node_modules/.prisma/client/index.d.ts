  ...
  */
  ...
  export type DeliveriesGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends 'deliveryman' ? DeliverymanGetPayload<S['include'][P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'client' ? ClientsGetPayload<S['select'][P]> :
        P extends 'deliveryman' ? DeliverymanGetPayload<S['select'][P]> :  P extends keyof Deliveries ? Deliveries[P] : never
  } 
    : Deliveries
  : Deliveries
  ...
  export type DeliverymanScalarWhereWithAggregatesInput = {
    ...
    passwrod?: StringWithAggregatesFilter | string
  }
  ...
  export type DeliverymanUpdateInput = {
    ...
    passwrod?: StringFieldUpdateOperationsInput | string
